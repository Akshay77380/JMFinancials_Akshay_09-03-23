...
class FundTransactionControlller extends GetxController{
  ...
  Future<void> getPayoutRequest({String fromdate,String todate,String token, int payType}) async {
    try{
      isLoading(true);
      var stringResponse = payType == 3 ? await CommonFunction.getPayoutDetails({
      ...
      Dataconstants.payOutId = jsonResponse["data"][0]["detail"][0]["PayOutId"].toString();
