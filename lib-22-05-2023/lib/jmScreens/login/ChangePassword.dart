                                      ...
                                      children: [
                                        ...
                                        Center(
                                          child: SizedBox(
                                            ...
                                            child: ElevatedButton(
                                                onPressed: () {
                                                  widget.isSettingScreen ? Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => Login()), (route) => false) : Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => MobileNoScreen()), (route) => false);
