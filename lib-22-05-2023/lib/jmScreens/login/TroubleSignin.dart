...
class _TroubleSignInState extends State<TroubleSignIn> {
  ...
  Future<void> initState() {
    // if (_loginUserIDController.text.length > 0) isValidateEnable = true;
    _loginUserIDController.text = Dataconstants.selectedID;
    super.initState();
    getEvent();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  onChanged: (value) {
                    if (_loginUserIDController.text.length > 0) {
                      setState(() {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            Dataconstants.unblockUser = true;
                            Dataconstants.unblockId = _loginUserIDController.text;
                            CommonFunction.firebaseEvent(
                              clientCode: _loginUserIDController.text,
                              device_manufacturer: Dataconstants.deviceName,
                              device_model: Dataconstants.devicemodel,
                            ...
                            //         builder: (context) =>
                            //         // ChangePassword(false)
                            //         OtpScreen(Dataconstants.accountDetails[2], false)));
                            ...
                            var requestJson = {"LOGINID": Dataconstants.unblockId, "Otp": ""};
                            ...
                            if (jsons['status'] == false)
                              ...
                              Navigator.push(context, MaterialPageRoute(builder: (context) => OtpScreen(jsons["message"].toString().split("|")[1], false)));
                            }
                          },
                          child: Row(
                            children: [
