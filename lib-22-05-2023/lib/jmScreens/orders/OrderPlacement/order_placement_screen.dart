                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: AutoSizeText(
                                        widget.model.exchCategory == ExchCategory.nseEquity || widget.model.exchCategory == ExchCategory.bseEquity ? widget.model.desc : widget.model.marketWatchName,
                                        maxLines: 1,
                                        style: Utils.fonts(size: 15.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor),
                                      ),
                                    ),
                                  ],
                                ),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(
                                              widget.model.name,
                                              style: Utils.fonts(size: 16.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor),
                                            ),
                                            const SizedBox(
                                              width: 5,
                                            ),
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Text(
                                                      ...
                                                      style: Utils.fonts(
                                                          size: 14.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor, fontWeight: FontWeight.w400),
                                                    ),
                                                  ],
                                                )),
                                            Visibility(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                ...
                                                //   decoration: BoxDecoration(
                                                //     borderRadius: BorderRadius.circular(5),
                                                //     color: orderFlow ? Utils.brightGreenColor : Utils.brightRedColor,s
                                                //   ),
                                                //   child: Text(orderFlow ? 'BUY' : 'SELL', style: Utils.fonts(size: 14.0, color: Utils.whiteColor, fontWeight: FontWeight.w500)),
                                                // ),
                                                const SizedBox(
