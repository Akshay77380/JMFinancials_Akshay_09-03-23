      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'MARKET DEPTH',
              style: Utils.fonts(fontWeight: FontWeight.w500, color: Utils.greyColor),
            ),
            const SizedBox(
              height: 15,
            ),
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('Qty', style: Utils.fonts(fontWeight: FontWeight.w600, color: Utils.greyColor)),
                          Text('Ord', style: Utils.fonts(fontWeight: FontWeight.w600, color: Utils.greyColor)),
                          Text('Bid', style: Utils.fonts(fontWeight: FontWeight.w600, color: Utils.darkGreenColor)),
                        ],
                      ),
                    ),
                    const SizedBox(
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text('Offer', style: Utils.fonts(fontWeight: FontWeight.w600, color: Utils.darkRedColor)),
                          Text('Ord', style: Utils.fonts(fontWeight: FontWeight.w600, color: Utils.greyColor)),
                          Text('Qty', style: Utils.fonts(fontWeight: FontWeight.w600, color: Utils.greyColor)),
                        ],
                      ),
                            ...
                            children: [
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  child: Text(widget.model.bidQty1.toString(),
                                      style: Utils.fonts(
                              ...
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.pop(context, widget.model.bidRate1.toStringAsFixed(widget.model.precision));
                                  },
                                ),
                              ),
                              const SizedBox(
                              ...
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.pop(context, widget.model.bidRate2.toStringAsFixed(widget.model.precision));
                                  },
                                ),
                              ),
                              const SizedBox(
                              ...
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.pop(context, widget.model.bidRate3.toStringAsFixed(widget.model.precision));
                                  },
                                ),
                              ),
                              const SizedBox(
                              ...
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    Navigator.pop(context, widget.model.bidRate5.toStringAsFixed(widget.model.precision));
                                  },
                                ),
                              ),
                            ],
                            ...
                            children: [
                                ...
                                builder: (_) => InkWell(
                                  ...
                                  onTap: () {
                                    if (widget.modalContext != null) {
                                      ...
                                      Navigator.pop(
                                          context,
                                          widget.model.offerRate1.toString()
                                      );
                                  },
                                ),
                              ),
                              ...
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  onTap: () {
                                    if (widget.modalContext != null) {
                                      Navigator.of(widget.modalContext).pop(widget.model.offerRate5.toStringAsFixed(2));
                                    }
                                    Navigator.pop(
                                        context,
                            ...
                            children: [
                              Observer(
                                builder: (_) => InkWell(
                                  ...
                                  child: Text(widget.model.offerQty1.toString(),
                                      style: Utils.fonts(
