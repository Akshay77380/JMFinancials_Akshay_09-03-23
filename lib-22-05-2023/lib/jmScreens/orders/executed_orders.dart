              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text("${order.status == 'partially executed' ? order.filledshares + '/' + order.quantity : order.status == 'open' ? order.filledshares : order.quantity}" + ' @ ' + '${order.ordertype == 'MARKET' ? order.averageprice :(order.ordertype == 'BRACKET' && order.stoploss == '0') ? order.squareoff :(order.ordertype == 'BRACKET' && order.squareoff == '0') ? order.stoploss :  order.price}',
