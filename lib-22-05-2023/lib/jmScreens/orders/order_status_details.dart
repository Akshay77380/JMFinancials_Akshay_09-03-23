                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "CLOSE",
                                  style: Utils.fonts(size: 14.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor),
                                ),
                              ),
                            ),
                          )
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text("STOCK YOU ${widget.order.transactiontype.toUpperCase()}",
                                style: Utils.fonts(size: 13.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor)),
                            Padding(
                                ...
                                children: [
                                  Expanded(
                                    child: AutoSizeText(
                                        ...
                                        maxLines: 1,
                                        style: Utils.fonts(size: 20.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor, fontWeight: FontWeight.w700)),
                                  ),
                                  Observer(
                                      builder: (_) => Column(
                                            crossAxisAlignment: CrossAxisAlignment.end,
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                    ...
                                                    style: Utils.fonts(
                                                        size: 16.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor, fontWeight: FontWeight.w700)),
                                              ),
                                              Row(
                                                children: [
                                                  Text(
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text("CANCELLATION REASON", style: Utils.fonts(size: 13.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor)),
                                  Padding(
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text("REJECTION REASON", style: Utils.fonts(size: 13.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor)),
                                  Padding(
                                    padding: const EdgeInsets.symmetric(horizontal: 15.0, vertical: 10.0),
                                    child: Text("${widget.order.text}", style: Utils.fonts(size: 12.0, color: Colors.red), textAlign: TextAlign.center),
                                  )
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Obx(() {
                                            return Text('₹ ${LimitController.limitData.value.availableMargin.toString()}',
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Text('1,12,000.5', style: Utils.fonts(size: 12.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor))
                                        ],
                                      ),
                                      SizedBox(
                                        height: 8,
              ...
              Card(
                ...
                child: Column(
                  children: [
                    Container(
                      decoration: BoxDecoration(
                        color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.primaryColor : Utils.whiteColor,
                          ...
                          child: Row(
                            ...
                            children: [
                              GestureDetector(
                                ...
                                child: Text("ORDER BOOK", style: Utils.fonts(size: 14.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.whiteColor : Utils.blackColor)),
                              ),
                              VerticalDivider(
                                color: Utils.greyColor,
                                thickness: 2,
                              ...
                              widget.order.text.toLowerCase().contains('margin exceeds')
                                  ? InkWell(
                                      ...
                                      child: Text("ADD FUNDS", style: Utils.fonts(size: 14.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.whiteColor : Utils.blackColor)),
                                    )
                                  : InkWell(
                                      onTap: () {
                                      ...
                                      child: Text("WATCHLIST", style: Utils.fonts(size: 14.0, color: Utils.whiteColor)),
                                    ),
                            ],
                          ),
                        ),
                    ...
                    widget.order.text.toLowerCase().contains('margin exceeds')
                        ? GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text("INCREASE MARGIN", style: Utils.fonts(size: 14.0, color: ThemeConstants.themeMode.value == ThemeMode.light ? Utils.blackColor : Utils.whiteColor)),
                            ),
                          )
                        : GestureDetector(
                            behavior: HitTestBehavior.opaque,
                            ...
                            child: Container(
                              ...
                              width: size.width,
                              padding: const EdgeInsets.symmetric(vertical: 15.0),
                              child: Text(status ? "ADD MORE" : "RETRY", style: Utils.fonts(size: 14.0, color: Theme.of(context).brightness == Brightness.dark ? Utils.whiteColor : Utils.blackColor)),
                            ),
                          ),
                  ],
                ),
