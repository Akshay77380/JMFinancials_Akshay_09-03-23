                        ...
                        children: [
                          ...
                          Obx(() {
                            return GetRequiredMarginController.isLoading.value
                                ? Text(
                                widget.productType == "NRML" || widget.productType == "MTF" || widget.productType == "MIS"
                                    ? (int.parse(widget.qty) * widget.model.close * (double.parse(GetRequiredMarginController.hairCut.value) / 100)).toStringAsFixed(2)
                                    : (int.parse(widget.qty) * widget.model.close).toStringAsFixed(2),
                                style: Utils.fonts(
                                  color: Utils.blackColor,
                                ))
                                : Text(
                                widget.productType == "NRML" || widget.productType == "MTF" || widget.productType == "MIS"
                                    ? (int.parse(widget.qty) * double.parse(widget.limitPrice) * (double.parse(GetRequiredMarginController.hairCut.value) / 100)).toStringAsFixed(2)
                                    : (int.parse(widget.qty) * double.parse(widget.limitPrice)).toStringAsFixed(2),
                                style: Utils.fonts(
                                  color: Utils.blackColor,
                                ));
                          }),
