...
class Commodity_Portfolio extends StatefulWidget {
  ...
  Commodity_Portfolio({Key key, this.mtm_pl, this.marginused})
      : super(key: key);
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  ...
                                                                                  style: Utils.fonts(
                                                                                    size: 14.0,
                                                                                    color: PortfolioDerivateController.getDetailResultListItems2[index].pl >= 0 ? Utils.mediumGreenColor : Utils.mediumRedColor,
                                                                                    fontWeight: FontWeight.w700,
                                                                                  ),
                                                                                ),
                                                                                Padding(
                                                                                  padding: const EdgeInsets.only(left: 4.0),
                                                                                  child: PortfolioDerivateController.getDetailResultListItems2[index].pl >= 0
                                                                                      ? SvgPicture.asset(
