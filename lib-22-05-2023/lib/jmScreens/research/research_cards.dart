...
class _InvestmentCardState extends State<InvestmentCard> {
  ...
  void navigateInvest({bool isBuy, ThemeData theme}) {
    showModalBottomSheet<void>(
      ...
      isScrollControlled: true,
      context: context,
      builder: (BuildContext context) => OrderPlacementBottomSheet(
          segment: "Investment",
          stockName: widget.data.header,
          isBuy: isBuy,
                                  ...
                                  children: [
                                    ...
                                    Observer(builder: (_) {
                                      ...
                                      widget.data.model.close == 0.00
                                          ? widget.data.model.prevDayClose == 0.00
                                              ? widget.data.buysell.toUpperCase() == "BUY"
                                                  ? profitPotential = ((double.parse(widget.data.targetprice) - double.parse(widget.data.price)) * widget.data.model.minimumLotQty * 1000)
                                                  : profitPotential = ((double.parse(widget.data.price) - double.parse(widget.data.targetprice)) * widget.data.model.minimumLotQty * 1000)
                                              : widget.data.buysell.toUpperCase() == "BUY"
                      ...
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) {
                            ...
                            return ScriptInfo(_groupValue == 'NSE' ? widget.currentModel : widget.currentModel.alternateModel, false);
                          },
                        ),
                      );
                    },
