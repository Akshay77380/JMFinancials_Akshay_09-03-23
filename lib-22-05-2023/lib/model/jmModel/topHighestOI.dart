...
//
//     final topHighestOiModel = topHighestOiModelFromJson(jsonString);

import 'dart:convert';

TopHighestOiModel topHighestOiModelFromJson(String str) => TopHighestOiModel.fromJson(json.decode(str));

String topHighestOiModelToJson(TopHighestOiModel data) => json.encode(data.toJson());

class TopHighestOiModel {
  TopHighestOiModel({
      this.success,
      this.data,
      this.status,
  ...
  factory TopHighestOiModel.fromJson(Map<String, dynamic> json) => TopHighestOiModel(
