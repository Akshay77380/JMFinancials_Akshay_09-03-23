...
class NumberFieldBigul extends StatefulWidget {
  ...
  @override
  _NumberFieldBigulState createState() => _NumberFieldBigulState();
}

class _NumberFieldBigulState extends State<NumberFieldBigul> {
          ...
          Expanded(
            ...
            child: GestureDetector(
              ...
              onLongPressStart: (_) async {
                ...
                do {
                  increment();
                  if (_springDelay > 400) _springDelay -= 100;
                  await Future.delayed(Duration(milliseconds: _springDelay));
                } while (_isPressed);
              },
              onLongPressEnd: (_) {
...
class TriggerNumberField extends StatefulWidget {
  final TextEditingController numberController;
  final int maxLength;
  final double minValue;
  final double maxValue;
  ...
  @override
  _TriggerNumberFieldState createState() => _TriggerNumberFieldState();
}

class _TriggerNumberFieldState extends State<TriggerNumberField> {
  bool _isPressed = false;
  int _springDelay = 500;
  Timer _timer;
