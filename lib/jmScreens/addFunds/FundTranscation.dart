                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Text(
                            ...
                            style: Utils.fonts(
                                size: 12.0, fontWeight: FontWeight.w400),
                          ),
                          Spacer(),
                          InkWell(
                              onTap: () {
                      ...
                      Container(
                        ...
                        child: DropdownButton<String>(
                            isExpanded: true,
                            items: CommonFunction.productItems.keys
                                .map((String value) {
                              return DropdownMenuItem<String>(
                                ...
                                onTap: () {
                                  CommonFunction.productType = CommonFunction
                                      .productItems.values
                                      .toString();
                                },
                              );
                            ...
                            onChanged: (value) {
                              var todayDate = DateTime.now();
                              var last30Days = new DateTime(todayDate.year,
                                  todayDate.month - 1, todayDate.day);
                              var last10Days = new DateTime(todayDate.year,
                                  todayDate.month, todayDate.day - 10);
                              List<Detail> _list = [];
                              if (value == "Last 10 Days") {
                                for (int i = 0;
                                    i <
                                        FundTransactionControlller
                                            .getCustomFundTransactionList
                                            .length;
                                    i++) {
                                  print(CommonFunction.productItems.values
                                      .toString()
                                      .split(",")[0]
                                      .replaceAll("(", ""));
                                  ...
                                  var datecurrentDateEpoch =
                                      formatter.format(now);
                                  var currentDateEpoch =
                                      now.millisecondsSinceEpoch;
                                  var last10DaysEpoch =
                                      last10Days.millisecondsSinceEpoch;
                                  if (currentDateEpoch <= last10DaysEpoch) {
                                    _list.add(FundTransactionControlller
                                        .getFundTransactionListItems[i]);
                                  }
                                }
                                ...
                                for (int i = 0;
                                    i <
                                        FundTransactionControlller
                                            .getFundTransactionListItems.length;
                                    i++) {
                                  print(CommonFunction.productItems.values
                                      .toString()
                                      .split(",")[0]
                                  ...
                                  var currentDateEpoch =
                                      now.millisecondsSinceEpoch;
                                  var last30DaysEpoch =
                                      last30Days.millisecondsSinceEpoch;
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return FundTransactionRow(
                          index: index,
                          data: FundTransactionControlller
                              .getCustomFundTransactionList[index],
                          datum:
                              FundTransactionControlller.getFundTransactionList,
                        );
                        // return Text("ghjjk");
                      },
                      itemCount: FundTransactionControlller
                          .getCustomFundTransactionList.length,
                    ),
                  ),
                ),
              ],
                          ...
                          child: Center(
                            child: Column(
                              children: [
                                ...
                                Text(
                                  LimitController
                                      .limitData.value.openingBalance,
                                  // "0.00",
                                  style: Utils.fonts(
                                      size: 18.0, fontWeight: FontWeight.w600),
                                )
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                                      color:
                                          Utils.dullWhiteColor.withOpacity(0.5),
                                    ),
                                    child: Padding(
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      ...
                                      color: PayInController
                                                  .getPayInTransactionListItems[
                                                      index]
                                                  .status ==
                                              "failed"
                                          ? Utils.lightRedColor.withOpacity(0.2)
                      ...
                      itemCount:
                          PayInController.getPayInTransactionListItems.length,
                    ),
                  ),
                ),
              ],
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        ...
        //
        FundTransactionControlller.getFundTransactionList.map(
          (e) {
            Iterable<CustomProcessed> processedList = FundTransactionControlller
                .getCustomFundTransactionList
                .where((element) =>
                    e.id == element.payOutId && element.status == "Processed");

            int approvedAmt = 0;
            for(CustomProcessed customProcessed in processedList){
              approvedAmt += int.parse(customProcessed.totalAmount);
            }

            e.approvedAmount = approvedAmt.toString();
          },
        );
        ...
        showModalBottomSheet(
            ...
            builder: (context) => PayDetails(
                ...
                details: FundTransactionControlller
                    .getCustomFundTransactionList[widget.index],
                fundTransactionModel: datummodel)).then((value) => setState(() {
