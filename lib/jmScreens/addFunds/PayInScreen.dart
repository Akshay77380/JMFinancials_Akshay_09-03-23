                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  PayInController.getPayInTransactionListItems[index].status,
                                  style: Utils.fonts(size: 12.0, color:  PayInController.getPayInTransactionListItems[index].status == "FAILED" ? Utils.lightRedColor.withOpacity(0.7) : Utils.lightGreenColor.withOpacity(0.7)),
                                ),
                              ),
                            ),
                          ),
