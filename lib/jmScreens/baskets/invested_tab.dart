...
import 'basket.dart';
import 'investedBasket.dart';

class investedTab extends StatefulWidget {
  @override
  State<investedTab> createState() => _investedTabState();
}

class _investedTabState extends State<investedTab> {
              ...
              child: BasketController.BasketList.isEmpty
                  ? Column(
                      ...
                      children: [
                        ...
                        SvgPicture.asset("assets/appImages/basket/basket.svg"),
                        SizedBox(
                          height: 50,
                        ),
                        Text(
                  ...
                  : Column(
                      children: [
                        for (var i = 0;
                            i < BasketController.BasketList.length;
                            i++)
                          Column(
                            children: [
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    //             BasketController
                                    //                 .BasketList[i].basketName
                                    //                 .toString(),
                                    //             BasketController
                                    //                 .BasketList[i].basketId
                                    //                 .toString()))).then(
                                    //     (value) {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => investedBasket(
                                            BasketController.BasketList[i]),
                                      ),
                                    ).then((value) {
