...
class EquitySipOrderReportScreen extends StatefulWidget
{
  ...
  EquitySipOrderReportScreen({Key key}) : super(key: key);

//  const EquitySipOrderReportScreen({Key key, this.model, this.activeSipCount}) : super(key: key);
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ValueListenableBuilder<int>(
                              valueListenable:  Dataconstants.active_counter?? ValueNotifier<int>(0),
                              builder: (BuildContext context, int count, Widget child) {
                                return CircleAvatar(
                                  ...
                                  maxRadius: 11,
                                  child: Text(
                                   '${Dataconstants.active_counter.value}',
