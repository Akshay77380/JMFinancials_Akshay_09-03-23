                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Dataconstants.holdingIndex == 0 ? Obx(() => Text(
                                HoldingController.totalVal.value.toStringAsFixed(2),
                                style: Utils.fonts(
                                  size: 16.0,
                                  fontWeight: FontWeight.w400,
                                ),
                              )) : Obx(() => Text(
                            HoldingController.mtfTotalVal.value.toStringAsFixed(2),
                            style: Utils.fonts(
                              size: 16.0,
                              fontWeight: FontWeight.w400,
                            ),
                            ...
                            child: TabBar(
                              ...
                              tabs: [
                                Container(
                                  height: 35,
                                  decoration: BoxDecoration(
                                      border: Border.all(color: _currentIndex == 0 ? Utils.primaryColor : Colors.transparent)),
