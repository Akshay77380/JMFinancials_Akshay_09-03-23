...
//
//     final topLowestOiModel = topLowestOiModelFromJson(jsonString);

import 'dart:convert';

TopLowestOiModel topLowestOiModelFromJson(String str) => TopLowestOiModel.fromJson(json.decode(str));

String topLowestOiModelToJson(TopLowestOiModel data) => json.encode(data.toJson());

class TopLowestOiModel {
  TopLowestOiModel({
       this.success,
       this.data,
       this.status,
  ...
  factory TopLowestOiModel.fromJson(Map<String, dynamic> json) => TopLowestOiModel(
