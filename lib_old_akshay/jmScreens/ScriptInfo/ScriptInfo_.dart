...
class _ScriptInfoState extends State<ScriptInfo> with AutomaticKeepAliveClientMixin, TickerProviderStateMixin, WidgetsBindingObserver {
  ...
  void initState() {
    ...
    setState(() {
      widget.model.exch == "N" ? _isNse = true : _isNse = false;
    });

    if (widget.model.exch == "N" || widget.model.exch == "B") {
      model1 = widget.model;
      model2 = widget.model.alternateModel;
    }
                                  ...
                                  ? InkWell(
                                      onTap: () {
                                        setState(() {
                                          ...
                                          // widget.model.exch == "B" ? model = model1 : model = model2 ;

                                          if(widget.model.exch == "B" && model1.exch == "B"){
                                            model = model1;
                                            ...
                                            Dataconstants.iqsClient.sendMarketDepthRequest(
                                                model1.exch,
                                                model1.exchCode, false
                                            );
                                          }
                                          else if(widget.model.exch == "B" && model1.exch == "N"){
                                            model = model2;
                                            Dataconstants.iqsClient.sendLTPRequest(
                                              model2,
                                              false,
                                            ...
                                            Dataconstants.iqsClient.sendMarketDepthRequest(
                                                model2.exch,
                                                model2.exchCode, false
                                            );
                                          }
                                          else if(widget.model.exch == "N" && model1.exch == "B"){
                                            model = model2;
                                            Dataconstants.iqsClient.sendLTPRequest(
                                              model2,
                                              false,
                                          ...
                                          else if(widget.model.exch == "N" && model1.exch == "N"){
                                            model = model2;
                                            Dataconstants.iqsClient.sendLTPRequest(
                                              model2,
                                              false,
        ...
        Column(
          ...
          children: [
            ...
            Padding(
                ...
                child: Observer(builder: (context) {
                  return Text(
                    model.exch == "C" ? model.lowerCktLimit.toStringAsFixed(4) : model.lowerCktLimit.toStringAsFixed(4),
                    style: Utils.fonts(fontWeight: FontWeight.w700, size: 13.0),
                  );
                })),
            Padding(
