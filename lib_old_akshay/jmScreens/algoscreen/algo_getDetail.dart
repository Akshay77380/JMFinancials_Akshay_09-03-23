...
class AlgoGetDetail extends StatefulWidget {
  ...
  const AlgoGetDetail({Key key, this.modifyModel, this.instructionId, this.buySel}) : super(key: key);

  @override
  State<AlgoGetDetail> createState() => _AlgoGetDetailState(modifyModel, instructionId, buySel);
}
...
class _AlgoGetDetailState extends State<AlgoGetDetail> {
  ...
  _AlgoGetDetailState(ScripInfoModel modifyModel, int instructionId, String buySel);

  @override
  void initState() {
    super.initState();
    Dataconstants.algoLogController.fetchAlgoLogDetail(insState: widget.instructionId);
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            Dataconstants.algoLogModel.scripName ?? " ",
                                            // "Axis Bank",
                                            // Dataconstants.isFinishedAlgoModify == true
                                            //     ? Dataconstants.finishedAlgoToAdvanceScreen.model.name
                                            //     : " ",
                                            style: TextStyle(fontSize: 15, color: theme.textTheme.bodyText1.color),
                                          ),
                                          Spacer(),
                                          Text(
                                      ...
                                      if (widget.buySel == "B" || Dataconstants.algoLogModel.algoName == "Averaging Scalper")
                                        Row(
                                          children: [
                                            Text(
                                      ...
                                      if (widget.buySel == "S" || Dataconstants.algoLogModel.algoName == "Averaging Scalper")
                                        Row(
                                          children: [
                                            Text(
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          currentModel == null
                                              ? Text('0.00')
                                              : Observer(
                                                  builder: (_) => DecimalText(currentModel.close.toStringAsFixed(currentModel.precision),
                                                      style: TextStyle(
                                                        fontSize: 16,
                                ...
                                child: Dataconstants.algoLogModel.logs.isEmpty
                                    ...
                                    : Padding(
                                        ...
                                        child: ListView.builder(
                                            itemCount: Dataconstants.algoLogModel.logs.length,
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                          ...
                                                          children: [
                                                            Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                  ...
                                                                  color: Color(int.parse(Dataconstants.algoLogModel.logs[index].color)).withOpacity(0.2) ?? theme.cardColor,
                                                                ),
                                                                child: Align(
                                                                    alignment: Alignment.center,
                                                                    child: Text(Dataconstants.algoLogModel.logs[index].event,
                                                                        // "Buy",
                                                                        style: TextStyle(
                                                                            color: Color(int.parse(Dataconstants.algoLogModel.logs[index].color)) ?? Colors.white,
                                                                            fontSize: 16,
                                                                            fontWeight: FontWeight.w500)))),

                                                            Text(
                                                              Dataconstants.algoLogModel.logs[index].dateTime.toString().split('T')[0].split(' ')[1].split('.')[0],
                                                              style: TextStyle(
                                                                fontSize: 16,
                                                              ),
                                                              // "17:22:00"
                                                            ...
                                                            // SizedBox(width: 40,),
                                                            if (Dataconstants.algoLogModel.logs[index].qty != 0 && Dataconstants.algoLogModel.logs[index].orderRef != "")
                                                        ...
                                                        if (Dataconstants.algoLogModel.logs[index].qty != 0)
                                                          Row(
                                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                            children: [
                                                              Text(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(" ${Dataconstants.algoLogModel.logs[index].event}" ?? " ", style: TextStyle(fontSize: 18)),
                                                                          ],
                                                                        ),
                                                                        SizedBox(
                                                                          height: 10,
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child: Text(Dataconstants.algoLogModel.logs[index].description,
                                                                              style: TextStyle(fontSize: 18),
                                                                              softWrap: true,
                                                                              maxLines: 5,
