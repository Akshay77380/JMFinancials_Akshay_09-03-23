...
class MarketStatsNext extends StatefulWidget {
  ...
  MarketStatsNext({Key key, @required this.name, this.currentTabIndex}) : super(key: key);

  @override
  State<MarketStatsNext> createState() => _MarketStatsNextState();
}

class _MarketStatsNextState extends State<MarketStatsNext> with SingleTickerProviderStateMixin {
  ...
  var mostActive = 1;
  var mostActiveTab = 1;
  static var  topGainersTab = 1;
  static var topLosersTab  = 1;
  ...
  void initState() {
    ...
    Dataconstants.fiftyTwoWeekHighController.getFiftyTwoWeekHigh("NSE");
    ...
    Dataconstants.mostActiveVolumeController.getMostActiveVolume("NSE", "Nifty");
  ...
  //                               border: Border(
  //                             top: topGainers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             bottom: topGainers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             right: topGainers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                             left: topGainers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                           )),
  //                           child: Padding(
  //                             padding: const EdgeInsets.all(4.0),
  //                             child: Text("15 Minutes", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topGainers == 1 ? Utils.primaryColor : Utils.greyColor)),
  //                           ),
  //                         ),
  //                       ),
  //
  ...
  //                           decoration: BoxDecoration(
  //                               border: Border(
  //                             top: topGainers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             bottom: topGainers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             right: topGainers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                             left: topGainers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                           )),
  //                           child: Padding(
  //                             padding: const EdgeInsets.all(4.0),
  //                             child: Text("1 Hour", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topGainers == 2 ? Utils.primaryColor : Utils.greyColor)),
  //                           ),
  //                         ),
  //                       ),
  //                       InkWell(
  ...
  //                           decoration: BoxDecoration(
  //                               border: Border(
  //                             top: topGainers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             bottom: topGainers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             right: topGainers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                             left: topGainers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                           )),
  //                           child: Padding(
  //                             padding: const EdgeInsets.all(4.0),
  //                             child: Text("1 Day", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topGainers == 3 ? Utils.primaryColor : Utils.greyColor)),
  //                           ),
  //                         ),
  //                       ),
  //                       InkWell(
  ...
  //                           decoration: BoxDecoration(
  //                               border: Border(
  //                             top: topGainers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             bottom: topGainers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             right: topGainers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                             left: topGainers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                           )),
  //                           child: Padding(
  //                             padding: const EdgeInsets.all(4.0),
  //                             child: Text("5 Days", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topGainers == 4 ? Utils.primaryColor : Utils.greyColor)),
  //                           ),
  //                         ),
  //                       ),
  //                       InkWell(
  ...
  //                           decoration: BoxDecoration(
  //                               border: Border(
  //                             top: topGainers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             bottom: topGainers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             right: topGainers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                             left: topGainers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                           )),
  //                           child: Padding(
  //                             padding: const EdgeInsets.all(4.0),
  //                             child: Text("1 Month", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topGainers == 5 ? Utils.primaryColor : Utils.greyColor)),
  //                           ),
  //                         ),
  //                       ),
  //                       InkWell(
  ...
  //                           decoration: BoxDecoration(
  //                               border: Border(
  //                             top: topGainers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             bottom: topGainers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             right: topGainers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                             left: topGainers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                           )),
  //                           child: Padding(
  //                             padding: const EdgeInsets.all(4.0),
  //                             child: Text("YTD", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topGainers == 6 ? Utils.primaryColor : Utils.greyColor)),
  //                           ),
  //                         ),
  //                       ),
  //                     ],
  ...
  //                     //       decoration: BoxDecoration(borderRadius: BorderRadius.circular(7), color: Utils.greyColor.withOpacity(0.2)),
  //                     //       child: Row(
  //                     //         mainAxisAlignment: MainAxisAlignment.center,
  //                     //         children: [
  //                     //           Text(
  //                     //             "Monthly",
  //                     //             style: Utils.fonts(size: 12.0, fontWeight: FontWeight.w500, color: Theme.of(context).textTheme.bodyText1.color),
  //                     //           ),
  //                     //           RotatedBox(
  //                     //               quarterTurns: 2,
  ...
  //                                             exch: TopGainersController.getTopGainersListItems[index].stkExchng == "BSE" ? "B" : "N",
  //                                             exchCode: int.parse(TopGainersController.getTopGainersListItems[index].scCode.toString())), false)));
  //                               },
  //                               child: Padding(
  ...
  //                                             Padding(
  //                                               padding: const EdgeInsets.only(left: 8.0),
  //                                               child: TopGainersController.getTopGainersListItems[index].perchg >= 0
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                "${TopGainersController.getTopGainersListItems[index].perchg.toStringAsFixed(2)} %",
                                                style: Utils.fonts(
                                                  color: Utils.mediumGreenColor,fontWeight: FontWeight.w500,
                                                ),
                                              ),
                                            ],
                                          ),
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: Utils.fonts(
                                                  color: Utils.greyColor,fontWeight: FontWeight.w500,
                                                ),
                                              ),
                                            ],
                                          ),
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text(
                                                ...
                                                style: Utils.fonts(
                                                  color: Utils.lightRedColor,fontWeight: FontWeight.w500,
                                                ),
                                              ),
                                            ],
                                          ),
  ...
  //                 decoration: BoxDecoration(
  //                     border: Border(
  //                       top: topLosers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       bottom: topLosers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       right: topLosers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                       left: topLosers == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                     )),
  //                 child: Padding(
  //                   padding: const EdgeInsets.all(4.0),
  //                   child: Text("15 Minutes", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topLosers == 1 ? Utils.primaryColor : Utils.greyColor)),
  //                 ),
  //               ),
  //             ),
  //             InkWell(
  ...
  //                 decoration: BoxDecoration(
  //                     border: Border(
  //                       top: topLosers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       bottom: topLosers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       right: topLosers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                       left: topLosers == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                     )),
  //                 child: Padding(
  //                   padding: const EdgeInsets.all(4.0),
  //                   child: Text("1 Hour", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topLosers == 2 ? Utils.primaryColor : Utils.greyColor)),
  //                 ),
  //               ),
  //             ),
  //             InkWell(
  ...
  //                 decoration: BoxDecoration(
  //                     border: Border(
  //                       top: topLosers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       bottom: topLosers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       right: topLosers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                       left: topLosers == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                     )),
  //                 child: Padding(
  //                   padding: const EdgeInsets.all(4.0),
  //                   child: Text("1 Day", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topLosers == 3 ? Utils.primaryColor : Utils.greyColor)),
  //                 ),
  //               ),
  //             ),
  //             InkWell(
  ...
  //                 decoration: BoxDecoration(
  //                     border: Border(
  //                       top: topLosers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       bottom: topLosers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       right: topLosers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                       left: topLosers == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                     )),
  //                 child: Padding(
  //                   padding: const EdgeInsets.all(4.0),
  //                   child: Text("5 Days", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topLosers == 4 ? Utils.primaryColor : Utils.greyColor)),
  //                 ),
  //               ),
  //             ),
  //             InkWell(
  ...
  //                 decoration: BoxDecoration(
  //                     border: Border(
  //                       top: topLosers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       bottom: topLosers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       right: topLosers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                       left: topLosers == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                     )),
  //                 child: Padding(
  //                   padding: const EdgeInsets.all(4.0),
  //                   child: Text("1 Month", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topLosers == 5 ? Utils.primaryColor : Utils.greyColor)),
  //                 ),
  //               ),
  //             ),
  //             InkWell(
  ...
  //                 decoration: BoxDecoration(
  //                     border: Border(
  //                       top: topLosers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       bottom: topLosers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       right: topLosers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
  //                       left: topLosers == 6 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
  //                     )),
  //                 child: Padding(
  //                   padding: const EdgeInsets.all(4.0),
  //                   child: Text("YTD", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: topLosers == 6 ? Utils.primaryColor : Utils.greyColor)),
  //                 ),
  //               ),
  //             ),
  //           ],
  ...
  //                             MaterialPageRoute(
  //                                 builder: (context) => ScriptInfo(CommonFunction.getScripDataModel(
  //                                     exch: TopLosersController.getTopLosersListItems[index].stkExchng.name == "BSE" ? "B" : "N",
  //                                     exchCode: int.parse(TopLosersController.getTopLosersListItems[index].scCode.toString())), false)));
  //                       },
  //                       child: Row(
  //                         mainAxisAlignment: MainAxisAlignment.spaceBetween,
  //                         children: [
  ...
  //                                     child: Container(height: 15, width: 15, child: SvgPicture.asset("assets/appImages/markets/suitcase.svg")),
  //                                   ),
  //                                   Text('Markets',
  //                                       style: Utils.fonts(
  //                                         size: 12.0,
  ...
  //                                   Padding(
  //                                     padding: const EdgeInsets.only(left: 8.0),
  //                                     child: TopLosersController.getTopLosersListItems[index].perchg > 0
  //                                         ? SvgPicture.asset("assets/appImages/markets/inverted_rectangle.svg")
  //                                         : RotatedBox(
  //                                       quarterTurns: 2,
  //                                       child: SvgPicture.asset("assets/appImages/markets/inverted_rectangle.svg", color: Utils.lightRedColor),
  //                                     ),
  //                                   )
  //                                 ],
  //                               )
                ...
                children: [
                            ...
                            InkWell(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                        left: BorderSide(
                                          color: Dataconstants.mostActiveTab == 1 ? Utils.primaryColor : Utils.greyColor,
                                          width: 1,
                                        ),
                                        top: BorderSide(
                                          color: Dataconstants.mostActiveTab == 1 ? Utils.primaryColor : Utils.greyColor,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Volume",
                                      style: Utils.fonts(size: 12.0, color: Dataconstants.mostActiveTab == 1 ? Utils.primaryColor : Utils.greyColor, fontWeight: FontWeight.w500),
                                    ),
                                  )),
                            ),
                            InkWell(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                        left: BorderSide(
                                          color: Dataconstants.mostActiveTab == 2 ? Utils.primaryColor : Utils.greyColor,
                                          width: 1,
                                        ),
                                        top: BorderSide(
                                          color: Dataconstants.mostActiveTab == 2 ? Utils.primaryColor : Utils.greyColor,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Turnover",
                                      style: Utils.fonts(size: 12.0, color: Dataconstants.mostActiveTab == 2 ? Utils.primaryColor : Utils.greyColor, fontWeight: FontWeight.w500),
                                    ),
                                  )),
                            ),
                            InkWell(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                        left: BorderSide(
                                          color: Dataconstants.mostActiveTab == 3 ? Utils.primaryColor : Utils.greyColor,
                                          width: 1,
                                        ),
                                        top: BorderSide(
                                          color: Dataconstants.mostActiveTab == 3 ? Utils.primaryColor : Utils.greyColor,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Futures",
                                      style: Utils.fonts(size: 12.0, color: Dataconstants.mostActiveTab == 3 ? Utils.primaryColor : Utils.greyColor, fontWeight: FontWeight.w500),
                                    ),
                                  )),
                            ),
                            InkWell(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                        left: BorderSide(
                                          color: Dataconstants.mostActiveTab == 4 ? Utils.primaryColor : Utils.greyColor,
                                          width: 1,
                                        ),
                                        top: BorderSide(
                                          color: Dataconstants.mostActiveTab == 4 ? Utils.primaryColor : Utils.greyColor,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Calls",
                                      style: Utils.fonts(size: 12.0, color: Dataconstants.mostActiveTab == 4 ? Utils.primaryColor : Utils.greyColor, fontWeight: FontWeight.w500),
                                    ),
                                  )),
                            ),
                            InkWell(
                              ...
                              child: Container(
                                  decoration: BoxDecoration(
                                    border: Border(
                                        left: BorderSide(
                                          color: Dataconstants.mostActiveTab == 5 ? Utils.primaryColor : Utils.greyColor,
                                          width: 1,
                                        ),
                                        top: BorderSide(
                                          color: Dataconstants.mostActiveTab == 5 ? Utils.primaryColor : Utils.greyColor,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      "Puts",
                                      style: Utils.fonts(size: 12.0, color: Dataconstants.mostActiveTab == 5 ? Utils.primaryColor : Utils.greyColor, fontWeight: FontWeight.w500),
                                    ),
                                  )),
                            ),
                          ],
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Dataconstants.mostActiveTab == 2
                        ...
                        : Dataconstants.mostActiveTab == 3 || Dataconstants.mostActiveTab == 4 || Dataconstants.mostActiveTab == 5
          ...
          children: [
            InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                    border: Border(
                      top: mostActive == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      bottom: mostActive == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      right: mostActive == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                      left: mostActive == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                    )),
                child: Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: Text("Volume", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: mostActive == 1 ? Utils.primaryColor : Utils.greyColor)),
                ),
              ),
            ),
            InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                    border: Border(
                      top: mostActive == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      bottom: mostActive == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      right: mostActive == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                      left: mostActive == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                    )),
                child: Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: Text("Turnover", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: mostActive == 2 ? Utils.primaryColor : Utils.greyColor)),
                ),
              ),
            ),
            InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                    border: Border(
                      top: mostActive == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      bottom: mostActive == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      right: mostActive == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                      left: mostActive == 3 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                    )),
                child: Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: Text("Futures", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: mostActive == 3 ? Utils.primaryColor : Utils.greyColor)),
                ),
              ),
            ),
            InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                    border: Border(
                      top: mostActive == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      bottom: mostActive == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      right: mostActive == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                      left: mostActive == 4 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                    )),
                child: Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: Text("Calls", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: mostActive == 4 ? Utils.primaryColor : Utils.greyColor)),
                ),
              ),
            ),
            InkWell(
              ...
              child: Container(
                decoration: BoxDecoration(
                    border: Border(
                      top: mostActive == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      bottom: mostActive == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      right: mostActive == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                      left: mostActive == 5 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                    )),
                child: Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: Text("Puts", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: mostActive == 5 ? Utils.primaryColor : Utils.greyColor)),
                ),
              ),
            ),
          ],
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(FiftyTwoWeekHighController.getFiftyTwoWeekHighListItems[index].coName,
                                style: Utils.fonts(
                                  size: 14.0,
                                  color: Utils.blackColor,
                                  fontWeight: FontWeight.w500,
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: Utils.fonts(
                                    size: 12.0,
                                    color: FiftyTwoWeekHighController.getFiftyTwoWeekHighListItems[index].high > FiftyTwoWeekHighController.getFiftyTwoWeekHighListItems[index].price
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  ...
                                  style: Utils.fonts(
                                    size: 12.0,
                                    color: FiftyTwoWeekLowController.getFiftyTwoWeekLowListItems[index].low < FiftyTwoWeekLowController.getFiftyTwoWeekLowListItems[index].price
                                        ? Utils.lightRedColor
                                        : Utils.lightGreenColor,
                                    fontWeight: FontWeight.w500,
                                  ),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  '${OiGainersController.getOiGainersDetailsListItems[index].faOchange.toStringAsFixed(2)}%',
                                  style: Utils.fonts(
                                    size: 12.0,
                                ...
                                Padding(
                                    padding: const EdgeInsets.only(left: 8.0),
                                    child: OiGainersController.getOiGainersDetailsListItems[index].faOchange > 0
                                        ? SvgPicture.asset("assets/appImages/markets/inverted_rectangle.svg")
                                        : RotatedBox(
                                      quarterTurns: 2,
                                      child: SvgPicture.asset(
                    ...
                    Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(OiLosersController.getOiLosersDetailsListItems[index].symbol,
                                style: Utils.fonts(
                                  size: 14.0,
                                  color: Utils.blackColor,
                                  fontWeight: FontWeight.w500,
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 8.0),
                                  child: OiLosersController.getOiLosersDetailsListItems[index].faOchange > 0
                                      ? SvgPicture.asset("assets/appImages/markets/inverted_rectangle.svg")
                                      : RotatedBox(
                                    quarterTurns: 2,
                                    child: SvgPicture.asset(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text(title, style: Utils.fonts(size: 14.0, fontWeight: index == i ? FontWeight.w600 : FontWeight.w400, color: index == i ? Utils.primaryColor : Utils.blackColor)),
                index == i
                    ? SvgPicture.asset('assets/appImages/markets/checkbox_circle_blue.svg')
                    : Container(
                  height: 17,
                  width: 17,
                  decoration: BoxDecoration(
    ...
    return Column(children: [
      ...
      Padding(
        ...
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Text("Select Index", style: Utils.fonts(fontWeight: FontWeight.w700, size: 17.0, color: Utils.blackColor)),
            Container(
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                          border: Border(
                            top: tabValue == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                            bottom: tabValue == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                            right: tabValue == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                            left: tabValue == 1 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                          )),
                      child: Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: Text("NSE", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: tabValue == 1 ? Utils.primaryColor : Utils.greyColor)),
                      ),
                    ),
                  ),
                  InkWell(
                    onTap: () {
                      tabValue = 2;
                      // Dataconstants.topGainersController.getTopGainers("bse" , "bse_sensex", "day");
                      // Dataconstants.topLosersController.getTopLosers("bse", "bse_sensex", "month");
                      // Dataconstants.mostActiveVolumeController.getMostActiveVolume("BSE", "Bse_sensex");
                      Dataconstants.fiftyTwoWeekHighController.getFiftyTwoWeekHigh("BSE");
                      setState(() {});
                    },
                    child: Container(
                      decoration: BoxDecoration(
                          border: Border(
                            top: tabValue == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                            bottom: tabValue == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide(color: Utils.greyColor),
                            right: tabValue == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                            left: tabValue == 2 ? BorderSide(color: Utils.primaryColor) : BorderSide.none,
                          )),
                      child: Padding(
                        padding: const EdgeInsets.all(4.0),
                        child: Text("BSE", style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: tabValue == 2 ? Utils.primaryColor : Utils.greyColor)),
                      ),
                    ),
                  ),
                ],
      ...
      ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Row(
                children : [
                  Text( Dataconstants.indicesMarketWatchListener.watchList[index].name,)
                ]
            );
          }
      )
