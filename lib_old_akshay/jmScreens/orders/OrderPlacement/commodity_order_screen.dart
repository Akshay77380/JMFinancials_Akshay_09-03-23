...
import 'package:markets/jmScreens/orders/OrderPlacement/commodity_order_review_screen.dart';
...
class CommodityOrderScreen extends StatefulWidget {
  ...
  @override
  State<CommodityOrderScreen> createState() => _CommodityOrderScreenState();
}

class _CommodityOrderScreenState extends State<CommodityOrderScreen> {
  final GlobalKey<ScaffoldMessengerState> _scaffoldKey = GlobalKey<ScaffoldMessengerState>();
  final _orderTypeController = ValueNotifier<bool>(false); // true = Market, false = Limit
  ...
  bool _isSLTPOrder = false, _isCoverOrder = false, _isBracketOrder = false, _isCoverRangeOpen = false, _isInt, isOpen = false;
  TextEditingController _numPadController = TextEditingController();
  String _limitValue, _productType, _validityType, _slLimitMarket, selectedFormatDate, coverBuyRange = '', coverSellRange = '';
  ...
  void initState() {
    ...
    _limitController.text = Dataconstants.scripInfoPrice != '' ? Dataconstants.scripInfoPrice : CommonFunction.getMarketRate(widget.model, widget.isBuy).toStringAsFixed(2);
                              ...
                              onTap: () {
                                setState(() {
                                  ...
                                  var requestForReqMargin = {
                                    ...
                                    "quantity_or_lot": _lotController.text,
                                    "Ltp": widget.model.close.toStringAsFixed(4),
                                    "scripcode": widget.model.exchCode.toString(),
                                    "tradingsymbol": widget.model.name
                                  };
                      ...
                      Obx(() {
                        return GetRequiredMarginController.isLoading.value
                            ...
                            : _orderTypeController.value
                                ...
                                : Text(
                                    _productType == "NRML" || _productType == "MTF" || _productType == "MIS"
                                        ? (int.parse(_qtyContoller.text == '' ? "0": _qtyContoller.text) * double.parse(_limitController.text)).toStringAsFixed(2) ?? "0"
                                        : (int.parse(_qtyContoller.text == '' ? "0": _qtyContoller.text) * double.parse(_limitController.text)).toStringAsFixed(2) ?? "0",
                                    style: Utils.fonts(
                                      color: Utils.blackColor,
                                    ));
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              InkWell(
                onTap: () async {
                  await Dataconstants.brokerageController.getBrokerage(widget.model.series, widget.isBuy ? "B" : "S", widget.model.exch == "N" ? "NSE" : "BSE", "E", widget.model.name,
                      widget.model.strikePrice, _productType, widget.model.expiryDateString, "", double.parse(_lotController.text) * widget.model.minimumLotQty, _limitController.text, 5000);
  ...
  void processPlace() async {
    if (widget.isBuy) {
      ...
      //         _limitController.text, widget.model)) {
      ...
      //     !CommonFunction.isValidTickSize(
      //         _triggerController.text, widget.model)) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      //       color: Colors.red,
      //       context: context,
      ...
      //       context: context,
      //       color: Colors.red,
      //       text: 'Limit Rate not within reasonable limits');
      //   return;
      // }
      ...
      //       color: Colors.red,
      //       context: context,
      //       text: 'Trigger Rate not within reasonable limits');
      //   return;
      // }

      // if (InAppSelection.buyFutureOrderMarketLimit == 1 && limit < 0.01) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      //       color: Colors.red,
      //       context: context,
      ...
      //   return;
      // }
      // if (InAppSelection.buyFutureOrderSL && trigger < 0.01) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      //       color: Colors.red,
      //       context: context,
      ...
      //         color: Colors.red,
      //         context: context,
      //         text: 'Trigger Price cannot be greater than Limit Price');
      //     return;
      //   }
      // }
    }
    if (!widget.isBuy) {
      ...
      // if (InAppSelection.sellFutureOrderMarketLimit == 1 &&
      //     !CommonFunction.isValidTickSize(
      //         _limitController.text, widget.model)) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      ...
      //   return;
      // }
      // if (InAppSelection.sellFutureOrderSL &&
      //     !CommonFunction.isValidTickSize(
      //         _triggerController.text, widget.model)) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      ...
      //       text: 'Trigger Rate not within reasonable limits');
      //
      // if (InAppSelection.sellFutureOrderMarketLimit == 1 && limit < 0.01) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      //       color: Colors.red,
      //       context: context,
      ...
      // }
      //
      // if (InAppSelection.sellFutureOrderSL && trigger < 0.01) {
      //   CommonFunction.showSnackBarKey(
      //       key: _scaffoldKey,
      //       color: Colors.red,
      //       context: context,
      ...
      //         color: Colors.red,
      //         context: context,
      //         text: 'Limit Price cannot be greater than Trigger Price');
      //     return;
      //   }
      // }
    }
    ...
    if (!_orderTypeController.value && !CommonFunction.rateWithin(
          widget.model.lowerCktLimit,
          widget.model.upperCktLimit,
          limit,
        )) {
    ...
    print("_limitController: ${_limitController.text}");

    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => CommodityOrderReviewScreen(
              model: widget.model,
            ...
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(BrokerageController.brokerageVal == null || BrokerageController.brokerageVal == '' ? "-" : "₹ ${BrokerageController.brokerageVal.toString()}"),
                ],
              ),
            ),
            Divider(),
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(BrokerageController.secCharge == null || BrokerageController.secCharge == '' ? "-" : "₹ ${BrokerageController.secCharge.toString()}"),
                ],
              ),
            ),
            Divider(),
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(BrokerageController.transCharge == null || BrokerageController.transCharge == '' ? "-" : "₹ ${BrokerageController.transCharge.toString()}"),
                ],
              ),
            ),
            Divider(),
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(BrokerageController.stampduty == null || BrokerageController.stampduty == '' ? "-" : "₹ ${BrokerageController.stampduty.toString()}"),
                ],
              ),
            ),
            Divider(),
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(BrokerageController.sebiTax == null || BrokerageController.sebiTax == '' ? "-" : "₹ ${BrokerageController.sebiTax.toString()}"),
                ],
              ),
            ),
            Divider(),
            Container(
              child: Row(
                ...
                children: [
                  ...
                  Text(BrokerageController.gst == null ? "-" : "₹ ${BrokerageController.gst.toString()}"),
                ],
              ),
            ),
            SizedBox(
            ...
            Container(
              child: Row(
                ...
                children: [
                  ...
                  //         .toStringAsFixed(2)),
                  Text(
                      "₹ ${((BrokerageController.gst == null || BrokerageController.gst == '' ? 0 : BrokerageController.gst) + BrokerageController.stampduty == '' || BrokerageController.stampduty == null ? 0 : BrokerageController.stampduty + BrokerageController.sebiTax == null || BrokerageController.sebiTax == '' ? 0 : BrokerageController.sebiTax + BrokerageController.brokerageVal == null || BrokerageController.brokerageVal == '' ? 0 : BrokerageController.brokerageVal + BrokerageController.secCharge == null || BrokerageController.secCharge == '' ? 0 : BrokerageController.secCharge + BrokerageController.transCharge == null || BrokerageController.transCharge == '' ? 0 : BrokerageController.transCharge).toString()}"),
                ],
              ),
            ),
            SizedBox(
