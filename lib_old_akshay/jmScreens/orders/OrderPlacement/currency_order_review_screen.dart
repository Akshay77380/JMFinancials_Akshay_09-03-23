...
class CurrencyOrderReviewScreen extends StatefulWidget {
  ...
  @override
  State<CurrencyOrderReviewScreen> createState() => _CurrencyOrderReviewScreenState();
}

class _CurrencyOrderReviewScreenState extends State<CurrencyOrderReviewScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    Future<bool> _onWillPop() async {
      setState(() {
        Dataconstants.currencyTransactionButton = true;
      });
      return Dataconstants.currencyTransactionButton;
    }
                ...
                child: Container(
                  ...
                  child: TextButton(
                    style: ButtonStyle(
                        ...
                        backgroundColor: widget.isBuy && Dataconstants.currencyTransactionButton
                            ? MaterialStateProperty.all<Color>(Utils.brightGreenColor)
                            : widget.isBuy && Dataconstants.currencyTransactionButton == false
                            ? MaterialStateProperty.all<Color>(Utils.brightGreenColor.withOpacity(0.5))
                            : widget.isBuy == false && Dataconstants.currencyTransactionButton
                    ...
                    onPressed: Dataconstants.currencyTransactionButton
                        ? () {
                      setState(() {
                        if (Dataconstants.currencyTransactionButton) {
                          Dataconstants.currencyTransactionButton = false;
                        } else {
                          Dataconstants.currencyTransactionButton = true;
                        }
                      });
