                          ...
                          child: Column(
                            children: [
                              ListView.builder(
                                ...
                                itemBuilder: (ctx, index) => AllOrderRow(
                                  key: ObjectKey(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                color: order.status == 'complete' ||  order.status == 'partially executed'
                                    ? ThemeConstants.buyColor.withOpacity(0.2)
                                    : order.status == 'rejected'
                                    ? ThemeConstants.sellColor.withOpacity(0.2)
                                    : order.status == 'open' ? Utils.primaryColor.withOpacity(0.2) :Utils.greyColor.withOpacity(0.2)),
                            child: Text(
                              order.status == 'complete' || order.status == 'open' ? 'PENDING' : order.status.toUpperCase(),
                              style: Utils.fonts(
                                  color: order.status == 'complete' ||  order.status == 'partially executed'
                                      ? ThemeConstants.buyColor
                                      : order.status == 'rejected'
                                      ? ThemeConstants.sellColor
                                      : order.status == 'open' ? Utils.primaryColor : Utils.greyColor,
                                  size: 10.0,
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: Utils.fonts(
                                      ...
                                      //         : Utils.greyColor,
                                      color: order.model.percentChange > 0 ? Utils.lightGreenColor :Utils.lightRedColor,
                                      size: 14.0,
                                      fontWeight: FontWeight.w600),
                                ),
                                Container(
                                  padding: const EdgeInsets.all(0.0),
                                  child: order.model.percentChange >= 0 ? RotatedBox(
                                    quarterTurns: 4,
                                    child: Icon(
                                    ...
                                    child: Icon(
                                      order.model.close > order.model.prevTickRate ? Icons.arrow_drop_up_rounded : Icons.arrow_drop_down_rounded,
                                      color: order.model.percentChange >= 0 ? Utils.mediumGreenColor : Utils.mediumRedColor,
                                    ),
                                  ),
                                )
                              ],
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              // Text(scripName[0].toUpperCase(),
                              Text(order.model.name.toUpperCase(), style: Utils.fonts(size: 16.0, fontWeight: FontWeight.bold, color: Utils.blackColor)),
                              Text(order.filledshares + '/' + '${int.tryParse(order.unfilledshares) + int.tryParse(order.filledshares)}' + ' @ ' + '${order.triggerprice}',
                                  style: Utils.fonts(size: 16.0, fontWeight: FontWeight.bold, color: Utils.blackColor)),
                            ],
                          ),
                          // /* Displaying the Script Description */
                                ...
                                builder: (_) => Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      //   color: order.model.close > order.model.prevTickRate ? Utils.mediumGreenColor : Utils.mediumRedColor,
                                      // )
                                      child: order.model.percentChange > 0 ? Icon(
