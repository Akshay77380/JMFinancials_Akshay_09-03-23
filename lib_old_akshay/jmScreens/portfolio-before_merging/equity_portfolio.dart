                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Row(
                                                                              ...
                                                                              children: [
                                                                                Row(
                                                                                  children: [
                                                                                    Text(holdingsList[index].scripName, style: Utils.fonts(size: 14.0, fontWeight: FontWeight.w700, color: Utils.blackColor)),
                                                                                  ],
                                                                                ),
                                                                                Column(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            currentModel =
                                                                                CommonFunction.getScripDataModelFastForIQS(exchPos: int.tryParse(holdingsList[index].scripCode) > 0 && int.tryParse(holdingsList[index].scripCode) < 34999 ? 0 : 2, exchCode: int.tryParse(holdingsList[index].scripCode));
                                                                            Navigator.of(context).push(
                                                                              MaterialPageRoute(
