...
class _zeroPortfolioState extends State<zeroPortfolio> {
  var res, nse_der = 'NSE DER', bse_der = 'BSE DER', nse_comm = 'NSE MCX', bse_comm = 'BSE MCX', nse_curr = 'NSE CDX', bse_curr = 'BSE CDX';
  double overallCostPrice = 0.0, overallLongValue = 0.0, marginused = 0.0, MTM_pl = 0.0, overallLongQty = 0.0, overallShortValue = 0.0, overall_currency_margin_used = 0.0;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      await Dataconstants.portfolioEquityController.getPortfolioEquity().then((value) {
        setState(() {});
      });
      await Dataconstants.portfolio_derivateController.getDetailResult().then((value) {
        setState(() {});
      });
      // fetchMTMPL('NSE DER');
      // fetchMTMPL('BSE DER');
  ...
  void fun1() async {
    try {
      ...
      res = await ITSClient.httpGetPortfolio("https://mobilepms.jmfonline.in/WebLoginValidatePassword3.svc/WebLoginValidatePassword3GetData?EncryptedParameters=14610051~~*~~*~~*~~*~~*~~*~~*", header);
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Portfolio"), actions: [
        InkWell(
            ...
            child: SvgPicture.asset("assets/appImages/portfolio/menu_icon.svg")),
        SizedBox(
          width: 15,
        ),
        InkWell(
          ...
          child: Column(
            children: [
                          ...
                          child: Row(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Obx(() {
                                    return DetailsControlller.isLoading.value
                                        ...
                                        : DetailsControlller.getDetailResultListItems.isEmpty
                                            ? Text("0")
                                            : Text(
                                                DetailsControlller.getDetailResultListItems[DetailsControlller.getDetailResultListItems.length - 1].netValue.toStringAsFixed(2),
                                                // " ",
                              ...
                              CircleAvatar(
                                ...
                                child: Center(child: SvgPicture.asset('assets/appImages/portfolio/zero_wallet.svg')),
                              ),
                            ],
                          ),
                        ),
                                  ...
                                  Obx(() {
                                    return DetailsControlller.isLoading.value
                                        ...
                                        : DetailsControlller.getDetailResultListItems.isEmpty
                                            ...
                                            : Text(
                                                DetailsControlller.getDetailResultListItems[DetailsControlller.getDetailResultListItems.length - 1].valuation.toStringAsFixed(2),
                                                style: Utils.fonts(fontWeight: FontWeight.w900, size: 14.0),
                                              );
                                  }),
                                  Text(
                                  ...
                                  Obx(() {
                                    return DetailsControlller.isLoading.value
                                        ...
                                        : DetailsControlller.getDetailResultListItems.isEmpty
                                            ...
                                            : Text(
                                                DetailsControlller.getDetailResultListItems[DetailsControlller.getDetailResultListItems.length - 1].unrealisedPl.toStringAsFixed(2),
                                                style: Utils.fonts(
                                                    fontWeight: FontWeight.w500,
                                                    size: 14.0,
                                                    color: DetailsControlller.getDetailResultListItems[DetailsControlller.getDetailResultListItems.length - 1].unrealisedPl < 0
                                                        ? Colors.red // set color to red if unrealisedPl is less than zero
                                                        : Utils.brightGreenColor // set color to green if unrealisedPl is greater than or equal to zero
                                                    ),
                                              );
                                  }),
                                  Text(
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Row(children: [
                  Center(child: SvgPicture.asset('assets/appImages/portfolio/zero_equity.svg')),
                  Padding(
                  ...
                  Container(height: 30, width: 30, child: Center(child: SvgPicture.asset('assets/appImages/arrow_right_circle.svg'))),
                ]),
              ),
              // Obx((){
              ...
              InkWell(
                onTap: Dataconstants.isGuestUser == true ? null : () async {
                ...
                child: Padding(
                  ...
                  child: Container(
                    height: MediaQuery.of(context).size.height * 0.185,
                    width: MediaQuery.of(context).size.width * 0.99,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.0), color: Color(0xff7cfaf2).withOpacity(0.2)),
                    child: Container(
                      // color: Color(0x7ca6fa),
                      child: Column(
                        children: [
                                    ...
                                    Obx(() {
                                      return PortfolioEquityController.isLoading.value
                                          ...
                                          : PortfolioEquityController.getPortfolioEquityListItems.isEmpty
                                              ? Text("No data available")
                                              : Text(
                                                  PortfolioEquityController.getPortfolioEquityListItems[PortfolioEquityController.getPortfolioEquityListItems.length - 1].unrealisedPl
                                                      .toStringAsFixed(2),
                                                  style: Utils.fonts(
                                                      fontWeight: FontWeight.w500,
                                                      size: 14.0,
              ...
              Row(children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Container(height: 30, width: 30, child: Center(child: SvgPicture.asset('assets/appImages/portfolio/zero_derivative.svg'))),
                ),
                Text(
                  "Derivative",
                  style: Utils.fonts(fontWeight: FontWeight.w900, size: 14.0),
              ...
              InkWell(
                onTap: Dataconstants.isGuestUser == true ? null : () {
                  Navigator.push(
                    context,
                                    ...
                                    children: [
                                      ...
                                      Obx(() {
                                        return PortfolioDerivateController.isLoading.value
                                            ? CircularProgressIndicator()
                                            : PortfolioDerivateController.getDetailResultListItems1.isEmpty
                                                ? Text("No data available")
                                                : Text(
              ...
              Row(children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Center(child: SvgPicture.asset('assets/appImages/portfolio/zero_commodity.svg')),
                ),
                Text(
                  "Commodity",
              ...
              Row(children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Container(height: 30, width: 30, child: Center(child: SvgPicture.asset('assets/appImages/portfolio/zero_currency.svg'))),
                ),
                Text(
                  "Currency",
                  style: Utils.fonts(fontWeight: FontWeight.w700, size: 14.0),
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    "Day's P/L",
                                    style: Utils.fonts(fontWeight: FontWeight.w500, color: Utils.greyColor, size: 14.0),
                                  ),
                                  Text(
                                    "-",
                                    style: Utils.fonts(fontWeight: FontWeight.w500, size: 14.0, color: Utils.brightGreenColor),
              ...
              Row(children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Center(child: SvgPicture.asset('assets/appImages/portfolio/zero_mutual_fund.svg')),
                ),
                Text(
                  "Mutual Funds",
                  style: Utils.fonts(fontWeight: FontWeight.w700, size: 14.0),
  ...
  Future<double> fetchMTMPL(String exchange) async {
    ...
    var res1 = await ITSClient.httpGetDpHoldings(
        "https://mobilepms.jmfonline.in/TrPositionsDerivativesFIFOCostDetail.svc/TrPositionsDerivativesFIFOCostDetailGetData?EncryptedParameters=14610051~~*~~*~~*~~*~~1.0.0.0~~*~~14610051", bs64);
    try {
      ...
      for (final Map<String, dynamic> item in data) {
        if (item['Exchange'] == exchange) {
          ...
          filteredData.add({'CostPrice': item['CostPrice'], 'LongQty': item['LongQty']});
  ...
  Future<double> fetchRealisedPl(String exchange) async {
    ...
    var res1 = await ITSClient.httpGetDpHoldings(
        "https://mobilepms.jmfonline.in/TrPositionsDerivativesFIFOCostDetail.svc/TrPositionsDerivativesFIFOCostDetailGetData?EncryptedParameters=14610051~~*~~*~~*~~*~~1.0.0.0~~*~~14610051", bs64);
    try {
      final Map<String, TrPositionsDerivativesFifoCostDetailGetDataResult> responseData = json.decode(res1);
