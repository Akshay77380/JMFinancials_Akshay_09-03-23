      ...
      appBar: AppBar(
          ...
          actions: [
            InkWell(
                ...
                child: SvgPicture.asset("assets/appImages/portfolio/grid_view_icon.svg")),
            SizedBox(width: 10,),
            InkWell(
                onTap: () {
                          ...
                          Column(
                            children: [
                              Column(
                                ...
                                Obx(() {
                                  return PortfolioEquityController.isLoading
                                      .value
                                      ...
                                      : Text(
                                    PortfolioEquityController
                                        .getPortfolioEquityListItems[PortfolioEquityController
                                        .getPortfolioEquityListItems.length -
                                        1].valuation.toStringAsFixed(2),
                                    // " ",
                                    style: Utils.fonts(
                              ...
                              Obx(()
                              {
                                return PortfolioEquityController.isLoading
                                  ...
                                  PortfolioEquityController
                                      .getPortfolioEquityListItems[PortfolioEquityController
                                      .getPortfolioEquityListItems.length -
                                      1].unrealisedPl.toStringAsFixed(2),
                                  style: Utils.fonts(
                                      fontWeight: FontWeight.w500,
                                      size: 14.0,
