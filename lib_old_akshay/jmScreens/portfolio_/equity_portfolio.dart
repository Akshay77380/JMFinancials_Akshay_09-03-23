                          ...
                          children: [
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  SvgPicture.asset(
                                    "assets/appImages/portfolio/green_dot.svg",
                                    // width: 200,
                                    // height: 200,
                                  ),
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "Adani Green Energy net profit rises 14% to \nRs 49 cr ",
                                          style: Utils.fonts(
                                              fontWeight: FontWeight.w600,
                                              size: 16.0),
                                        ),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            topGainersTab = 1;
                            Dataconstants.topGainersController
                                .getTopGainers("day","month","weekly");
                            setState(() {});
                          },
                          child: Container(
                              decoration: BoxDecoration(
                        ...
                        InkWell(
                          onTap: () {
                            topGainersTab = 2;
                            Dataconstants.topGainersController
                                .getTopGainers("Daily","month","weekly");
                            setState(() {});
                          },
                          child: Container(
                              decoration: BoxDecoration(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Expanded(
                                      flex: 2,
                                      child: Text(
                                        TopGainersController
                                            .getTopGainersListItems[
                                        index]
                                            .symbol,
                                        style: Utils.fonts(),
                                      ),
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              Dataconstants.topLosersController
                                  .getTopLosers("Daily","month","weekly");
                              setState(() {});
                            },
                            child: Container(
                                decoration: BoxDecoration(
