...
class _LimitScreenState extends State<LimitScreen> {
  ...
  List sourceLimit = [
    {
      'title': 'Cash Balance',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.openingBalance)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.openingBalance))}"
          : "0.00",
    },
    {
      'title': 'Notional Cash Credit',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.notionalcash)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.notionalcash))}"
          : "0.00",
    },
    {
      'title': 'Collateral Value',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.stockValuation)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.stockValuation))}"
          : "0.00",
    },
    {
      'title': 'Direct Collateral Credit',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.directcollateralvalue)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.directcollateralvalue))}"
          : "0",
    },
    {
      'title': 'Booked Profit on Margin Positions',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.realisedmtom)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.realisedmtom))}"
          : "0",
    },
    {
      'title': 'Pay In Amount',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.payinAmt)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.payinAmt))}"
          : "0",
    },
    {
      'title': 'Ad Hoc Margin Credit',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.adhocmargin)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.adhocmargin))}"
          : "0",
    },
    {
      'title': 'Net Delivery Sell Amount',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.cncsellcreditpresent)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.cncsellcreditpresent))}"
          : "0",
    },
    {
      'title': 'Net Premium Receivable',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.premiumpresent)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.premiumpresent))}"
          : "0",
    },
  ];
  List UtilsLimit = [
    ...
    },
    {
      ...
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.valueindelivery)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.valueindelivery))}"
          : "0.00",
    },
    {
    ...
    },
    {
      ...
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.unrealisedmtom)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.unrealisedmtom))}"
          : "0.00",
    },
    {
    ...
    },
    {
      ...
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.coMarginRequired)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.coMarginRequired))}"
          : "0.00",
    },
    {
      'title': 'Margin Used for BO',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.bOmarginRequired)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.bOmarginRequired))}"
          : "0.00",
    },
    {
      'title': 'Span Margin (Futures & Options Portfolio)',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.spanmargin)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.spanmargin))}"
          : "0.00",
    },
    {
      'title': 'Exposure Margin (Futures & Option Portfolio)',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.exposuremargin)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.exposuremargin))}"
          : "0.00",
    },
    {
      'title': 'CNC Margin Var Present',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.cncMarginVarPrsnt)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.cncMarginVarPrsnt))}"
          : "0.00",
    },
    {
    ...
    },
    {
      ...
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.viewrealizedmtom)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.viewrealizedmtom))}"
          : "0.00",
    },
    {
      'title': 'Unrealized Loss (MtoM) on Margin Positions',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.cncunrealizedmtomprsnt)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.cncunrealizedmtomprsnt))}"
          : "0.00",
    },
    {
      'title': 'Requested Payout',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.payoutAmt)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.payoutAmt))}"
          : "0.00",
    },
    {
      'title': 'SGB/ ETF/ NCD/ IPO Amount',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.ipoAmount)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.ipoAmount))}"
          : "0.00",
    },
    {
      'title': 'Mutual Fund Amount',
      'value': CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.mfamount)) != null
          ? "${CommonFunction.currencyFormat(double.parse(LimitController.limitData.value.mfamount))}"
          : "0.00",
    },
  ];
  var items = [];
  ...
  getPoaFlag() async {
    ...
    setState(() {
      Dataconstants.isPoa = pref.get("isPoa");
    });
    print(Dataconstants.isPoa);
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(builder: (context) => FundTransactions(index: 100)));
                            },
                            child: Row(
                              children: [
                                Text(
                  ...
                  SizedBox(
                    height: Dataconstants.isPoa == "N" ? 100 : 10,
                  ),
                ],
              ),
            ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () async {
                  await WidgetsBinding.instance.addPostFrameCallback((_) async {
                    res = await CommonFunction.checkMarket({
                      "token": Dataconstants.fundstoken,
                    });
                    var res2 = jsonDecode(res);
                    Dataconstants.checkMarket = await res.toString().contains("true") ? true : false;
                    Dataconstants.chkMktMsg = await res.toString().split("[")[1];
                    for (var i = 0; i < Dataconstants.chkMktMsg.length; i++) {
                      Dataconstants.chkMktMsg2.add(Dataconstants.chkMktMsg.toString().split("."));
                    }
                    Dataconstants.checkMarketController.getCheckMarket();

                    if (Dataconstants.checkMarket != null) Navigator.push(context, MaterialPageRoute(builder: (context) => AddMoney(money: "0", fromActivity: "Limits", type: "withdraw")));
                  });
                },
                child: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 15.0, horizontal: 20.0),
