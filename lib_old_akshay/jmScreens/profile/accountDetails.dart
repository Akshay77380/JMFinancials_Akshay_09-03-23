...
import 'package:markets/controllers/BankDetailsController.dart';
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() {
                        return BankDetailsController.isLoading.value
                            ? Center(child: CircularProgressIndicator())
                            : BankDetailsController.getBankDetailsListItems.length == 0
                            ? Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
                          Text('You do not have any banks in your account', style: Utils.fonts(size: 11.0, fontWeight: FontWeight.w500, color: Utils.greyColor)),
                        ])
                            : ListView.builder(
                          shrinkWrap: true,
                          itemCount: BankDetailsController.getBankDetailsListItems.length,
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          BankDetailsController.getBankDetailsListItems[index].name,
                                          style: Utils.fonts(
                                            size: 14.0,
                                          ),
                                        ),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Icon(Icons.circle, size: 8, color: Utils.greyColor.withOpacity(0.8)),
                                            Text(
                                              BankDetailsController.getBankDetailsListItems[index].name.split(" ")[1],
