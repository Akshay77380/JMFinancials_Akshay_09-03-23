        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => ScriptInfo(
              Dataconstants.preDefinedWatchListeners[watchlistNo].watchList[index],false
            ),
          ),
        );
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                          Dataconstants.preDefinedWatchListeners[watchlistNo].watchList[index].name.toUpperCase(),
                          style: Utils.fonts(
                              size: 14.0,
                ...
                Expanded(
                  ...
                  child: Observer(
                    /* Checking if we got the chart data of the current script by checking its array length,
                     if not then shrink. The UI will throw error */
